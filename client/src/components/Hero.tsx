    ...
    >
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
        <div className="order-2 md:order-1 space-y-6">
          <p className="font-mono text-neonBlue opacity-80 fade-up">
            Hi, my name is
          </p>
          ...
          <p className="text-lg md:text-xl text-textSecondary max-w-xl fade-up delay-2">
            A motivated and detail-oriented individual seeking opportunities in
            the field of Computer Systems Engineering. Proficient in Python,
            JavaScript, React, Laravel, and MySQL. Skilled in web development
            with a passion for AI integration and problem-solving.
          </p>
